...
const { initFaceApi } = require("../face-api/loadModels")
const { attachFaceApi, deleteFaceApi } = require("../face-api/face-api")
const { createAudioVisualizer } = require("../audio/visualizer")
...
const { normalTemplate, screenSharingTemplate, videoContainerScreenSharingTrigger, changeLayout } = require("../ui/template")
const { resetButton, resetButtonChat, resetButtonUserList } = require("../ui/controllers")
const { getScreenSharing } = require("../video/screensharing")
...
module.exports = { mediasoupClient, totalUsers, device, rtpCapabilities, producerTransport, consumerTransports, audioProducer, videoProducer, screenSharingProducer, producersDetails, deviceId, currentTemplate, screenSharingStreamsGlobal, isRecording, recordedStream, recordedMedia, allStream, audioContext, audioDestination, paginationStartIndex, paginationEndIndex, currentPage, limitedPerPage, isCameraOn, isMicOn, lockedMic, host, isMutedAll, isFaceRecognition, isFaceApiReady, screenSharingParams, consumingTransports, isScreenSharing, screenSharingInfo, localVideo, videoContainer }
